...
gvCoal = { AllowedTypes = {	[Entities.CB_Mint1] = true,
		...
		TooltipText = {Coal = {["de"] = "Kohle erhalten: ", ["en"] = "Coal earned: "},
						Wood = {["de"] = "Holz verbrannt: ", ["en"] = "Wood burned: "}},
		...
		ResourceByLevel = {4, 6}, PickaxeFactor = 1.5, TooltipText = {["de"] = "Kohle gefördert: ", ["en"] = "Coal mined: "},
