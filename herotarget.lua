gvHeroTarget = {Thresholds = {CriticalCharge = 0.9,
				...
				BombThreatRange = 500,
				BaseThreatVal = {	[Entities.PU_Hero1c] = 0.5,
				...
				MainThreat = {	[Entities.PU_Hero1c] = {"CloseRange", Abilities.AbilityInflictFear},
				...
				CloseRangeSpec = function(_id, _heroID, _ability)
					...
					if type == Entities.PU_Hero13 then
						if gvHero13.TriggerIDs[_ability].Judgment[player] then
							if dist < gvHero13[_ability].Judgment.BaseRange then
