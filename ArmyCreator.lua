ArmyCreator = {TroopLimit = 10, PointCosts = {	[Entities.PU_LeaderSword1] = 4,
												...
												[Entities.PU_LeaderHeavyCavalry2] = 13,
												...
												[Entities.CU_Mary_de_Mortfichet] = 25,
